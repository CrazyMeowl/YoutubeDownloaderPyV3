	...
	if len(LN) == 0 :
		...
		try:
			...
			if form[i] == 1 :
				...
				search = search + "--download-archive 0DownloadList.txt " + Vs + outfolder + '"ytsearchNNNNN:LN"'
			else:
				search = search + "--download-archive 0DownloadList.txt " + Vs + "--extract-audio --audio-format mp3 " + outfolder + '"ytsearchNNNNN:LN"'
			#Check for Link
